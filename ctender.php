...
">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link Dark link" href="ccompany.php">COMPANY</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link Dark link" href="ctender.php">TENDER</a>
      </li>
	...
	<form class="form-inline my-2 my-lg-0" action="" method="POST">
      <input class="form-control mr-sm-2" type="search" name="n" placeholder="Search" aria-label="Search">
      <button class="btn btn-outline-success my-2 my-sm-0" name="s" type="submit">Search</button>
    </form>
...
{
$n=$_POST['n'];
$q="select * from tender where name like '%".$n."%' or tender_detail like '%".$n."%'";
}
else 
{
...
if($sq)
{
	...
	{
	$sq=mysqli_query($cn,$q);
echo '<table  border="5px"><tr bgcolor="yellow">
<th>TENDER_ID </th>
