...
<th>E_id </th><th>ENQUIRY_NAME </th> 
<th>ENQUIRY_EMAIL </th><th>ENQUIRY_PHONE</th> 
<th>ENQUIRY_MESSAGE</th> <th>date</th>
<th>delete</th>
</tr>'; 
		while($r=mysqli_fetch_array($sq))
		{
			echo '<tr> <th>'.$r['e_id'].'</th>';
			echo ' <th> '.$r['name'].'</th>';
			echo ' <th> '.$r['email'].'</th>';
			echo ' <th> '.$r['phone'].'</th>';
			...
			echo ' <th> '.$r['date'].'</th>';
			$e_id=$r['e_id'];
echo ' <th><a href="addelenquire.php?e_id='.$e_id.'"> delete</a></th>';
			echo'</tr>';
		}
	echo '</table>';
	}
